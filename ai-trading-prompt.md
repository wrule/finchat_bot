...
如果 持有空仓：
    ...
    如果 当前价格 >= 86690 → 择机加仓空单（type: "2"，size: "0.001"）或持仓观望
    ⚠️ 无论价格涨多高，绝不止损平仓！硬扛到底！
如果 没有空仓：
    → 观望（hasOrder: false）
```
...
3. **🔒 无仓不动**：没有空仓时保持观望
4. **💪 硬扛不止损**：即使价格上涨亏损也不平仓，坚决持有等待回落
5. **🚫 禁止亏损平仓**：只有在盈利（价格 < 86690）时才允许平空
...
5. **💪 绝不止损** - 无论价格涨多高都不平仓，硬扛到底
6. **🚫 禁止亏损平仓** - CLOSE_SHORT 只能在价格 < 86690 时执行
7. **输出纯 JSON**
